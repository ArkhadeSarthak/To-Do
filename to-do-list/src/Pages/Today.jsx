...
function Today({ closeOpen, iconCLS, setTask, tasks, fetchTasks, searchQuery }) {
  ...
  const doneCount = todaysTask.filter((t) => t.Checked).length;
  const pendingCount = todaysTask.length - doneCount;
    ...
    <div className="todayPage">
      ...
      <div className="tpHeader">
        ...
        <div className="tpTitleGroup">
          <h1 className="tpTitle">Today</h1>
          <div className="tpStats">
            <span className="tpStatChip">{todaysTask.length} Total</span>
          ...
          {selected ? (
            <>
              ...
              <div className="tpDetailRow">
                <span className="tpDetailLabel"><FaTag /> List</span>
                <span className="tpDetailValue">{selected.List || "—"}</span>
              </div>
              <div className="tpDetailRow">
